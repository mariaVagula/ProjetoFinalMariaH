...
namespace ProjetoFinalMariaH.Migrations
{
    ...
    [Migration("20231207172237_Criacao-Inicial3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.Cidade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.Cliente", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.Colaborador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.Estado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.LocalRealizacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.Procedimento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.ProcedimentoRealizado", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.TipoColaborador", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.TipoProcedimento", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.Cidade", b =>
                {
                    b.HasOne("ProjetoFinalMariaH.Models.Estado", "Estado")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.Cliente", b =>
                {
                    b.HasOne("ProjetoFinalMariaH.Models.Cidade", "Cidade")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.Colaborador", b =>
                {
                    ...
                    b.HasOne("ProjetoFinalMariaH.Models.TipoColaborador", "TipoColaborador")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.Procedimento", b =>
                {
                    b.HasOne("ProjetoFinalMariaH.Models.TipoProcedimento", "TipoProcedimento")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoFinalMariaH.Models.ProcedimentoRealizado", b =>
                {
                    b.HasOne("ProjetoFinalMariaH.Models.Cliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("ClienteId");

                    b.HasOne("ProjetoFinalMariaH.Models.Colaborador", "Colaborador")
                        .WithMany()
                        .HasForeignKey("ColaboradorId");

                    b.HasOne("ProjetoFinalMariaH.Models.LocalRealizacao", "LocalRealizacao")
                        .WithMany()
                        .HasForeignKey("LocalRealizacaoId");

                    b.HasOne("ProjetoFinalMariaH.Models.Procedimento", "Procedimento")
                        .WithMany()
